...
from transformers import XLMRobertaModel, AutoTokenizer, AutoModelForSequenceClassification
...
class CustomClassifier(nn.Module):
    def __init__(self, args, num_label, len_tokenizer):
        ...
        self.pre_trained_model = XLMRobertaModel.from_pretrained(args.base_model)
